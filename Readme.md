...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ServerlessSpaWithDotNet*):

Restore dependencies
```
    cd "ServerlessSpaWithDotNet"
    dotnet restore
```

Execute unit tests
```
    cd "ServerlessSpaWithDotNet/test/ServerlessSpaWithDotNet.Tests"
    dotnet test
```

Deploy application
```
    cd "ServerlessSpaWithDotNet/src/ServerlessSpaWithDotNet"
